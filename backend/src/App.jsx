...
import PdfAdapter from './components/adapters/PdfAdapter';
import TemplateMethod from './components/template/TemplateMethod';
import CommandPattern from './components/command/CommandPattern';
import './App.css';
...
<button
              ...
              >
                ...
                className={`px-4 py-3 font-medium whitespace-nowrap transition-colors ${
                  activeTab === 'singleton'
{activeTab === 'adapter' && (              <div className="p-6">                <PdfAdapter />              </div>            )}            {activeTab === 'template' && (              <div className="p-6">                <TemplateMethod />              </div>            )}            {activeTab === 'command' && (              <div className="p-6">                <CommandPattern />              </div>            )}
